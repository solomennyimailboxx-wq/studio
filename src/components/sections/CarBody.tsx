...
const carParts = [
    { id: "front-bumper", name: "Передній бампер", d: "M28.6,85.2H0v119h50.2c-0.1-2-0.2-4-0.2-6V95.2C42.9,95.2,35.8,89.5,28.6,85.2z M558.1,95.2H42.9v23.8h233.2c15.3,0,29.6,4.4,42.3,12.3l28.9-11.9h135.6l31.1,11.9c13.3-7.7,28.5-11.9,44.1-12.3H600V95.2H558.1z" },
